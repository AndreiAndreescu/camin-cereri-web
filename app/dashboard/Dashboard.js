      ...
      <main>
              ...
              editingRequestId === r.id ? (
                <div key={r.id} className="request-card">
                  <div className="request-top">
                    <div className="request-title">Editare cerere #{r.id}</div>
                  </div>
                  <div className="row">
                    <div className="field">
                      <label>Centru</label>
                  ...
                  {editLegacyItems.length > 0 && (
                    <>
                      <p className="muted-note" style={{ marginBottom: 6 }}>
                        ...
                        rămân în cerere așa cum au fost scrise, sau le poți elimina:
                      </p>
        ...
        <section className="panel">
          ...
          <p className="muted-note" style={{ marginTop: -8, marginBottom: 14 }}>
            ...
            adăuga, edita și șterge produse. Ștergerea nu afectează cererile deja trimise.
          </p>

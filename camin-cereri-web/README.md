...
- Centrele nu mai sunt fixe: admin poate adăuga sau șterge centre oricând,
  ...
  de date.
- Admin poate șterge orice cont de utilizator din panoul **Utilizatori**
...
- Produsele nu se mai scriu liber: la o cerere nouă se bifează din catalogul
  de produse (panoul **Produse**, unde admin adaugă/elimină ce e nevoie) și
  se completează doar cantitatea pentru fiecare bifat.
